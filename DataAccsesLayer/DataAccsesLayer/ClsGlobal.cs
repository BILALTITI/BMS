...
namespace DVLD
{
    internal static class CLsGlobal
    {
        ...
        private static string keyPath = @"HKEY_CURRENT_USER\SOFTWARE\Bank";
        ...
        public static void SaveToEventLog(string Message, EventLogEntryType LogTybe, string SourceName = "Bank.App")
        {
